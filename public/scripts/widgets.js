...
async function renderWorkWeek(timeframe) {
  try {
    ...
    totalSpan.style.color = timeframe?.total.startsWith("-") ? "rgb(255, 121, 98)" : "#3ac363ff"
    totalSpan.textContent = `Total: ${timeframe?.total}`
